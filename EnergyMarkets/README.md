...
2. [Project Overview](#project-overview)
   ...
   - 2.3 [Data Flow Diagram](#data-flow-diagram)
3. [Power Purchase Agreements (PPAs)](#power-purchase-agreements-ppas)
   - 3.1 [Definition and Purpose](#definition-and-purpose)
   - 3.2 [Key Features of PPAs](#key-features-of-ppas)
   - 3.3 [Types of Power Purchase Agreements](#types-of-power-purchase-agreements)
   - 3.4 [Flows Between PPA Parties](#flows-between-ppa-parties)
   - 3.5 [Strategic Importance for Energy Investors](#strategic-importance-for-energy-investors)
4. [Intraday Power Trading](#intraday-power-trading)
   - 4.1 [Definition and Concept](#definition-and-concept)
   - 4.2 [Role in Power Markets](#role-in-power-markets)
   - 4.3 [Intraday Trading in Nordic Markets](#intraday-trading-in-nordic-markets)
5. [Market Data and Infrastructure](#market-data-and-infrastructure)
   - 5.1 [Nord Pool Exchange](#nord-pool-exchange)
   - 5.2 [ENTSO-E Transparency Platform](#entso-e-transparency-platform)
   - 5.3 [Data Sources for Nordic Markets (2024-2026)](#data-sources-for-nordic-markets-2024-2026)
6. [Intraday Market Statistics](#intraday-market-statistics)
   - 6.1 [Hourly Statistics Calculation](#hourly-statistics-calculation)
   - 6.2 [Key Performance Metrics](#key-performance-metrics)
7. [Trading Strategies](#trading-strategies)
   - 7.1 [Imbalance Arbitrage](#imbalance-arbitrage)
   - 7.2 [Energy Arbitrage](#energy-arbitrage)
8. [Setup and Installation](#setup-and-installation)
   - 8.1 [Prerequisites](#prerequisites)
   - 8.2 [Virtual Environment Setup](#virtual-environment-setup)
   - 8.3 [Installing Dependencies](#installing-dependencies)
   - 8.4 [Environment Configuration](#environment-configuration)
9. [Running the Application](#running-the-application)
   - 9.1 [Standalone Python Scripts](#standalone-python-scripts)
   - 9.2 [FastAPI Backend Server](#fastapi-backend-server)
   - 9.3 [Docker Deployment](#docker-deployment)
   - 9.4 [Docker Compose Full Stack](#docker-compose-full-stack)
10. [Python Scripts Documentation](#python-scripts-documentation)
    - 10.1 [ENTSO-E Data Collector](#entsoe-data-collector)
    - 10.2 [Nord Pool Data Collector](#nord-pool-data-collector)
    - 10.3 [Automated Background Tasks](#automated-background-tasks)
11. [Database Configuration](#database-configuration)
    - 11.1 [TimescaleDB Setup](#timescaledb-setup)
    - 11.2 [Schema and Indexes](#schema-and-indexes)
    - 11.3 [Data Retention Policies](#data-retention-policies)
12. [Visualization with Grafana](#visualization-with-grafana)
    - 12.1 [Grafana Setup](#grafana-setup)
    - 12.2 [Dashboard Configuration](#dashboard-configuration)
    - 12.3 [Query Examples](#query-examples)
    - 12.4 [Alert Configuration](#alert-configuration)
13. [Cloud Deployment on AWS](#cloud-deployment-on-aws)
    - 13.1 [Infrastructure Requirements](#infrastructure-requirements)
    - 13.2 [IAM Roles and Security](#iam-roles-and-security)
    - 13.3 [Deployment Architecture](#deployment-architecture)
    - 13.4 [Step-by-Step AWS Deployment](#step-by-step-aws-deployment)
14. [API Documentation](#api-documentation)
    - 14.1 [REST API Endpoints](#rest-api-endpoints)
    - 14.2 [Authentication](#authentication)
    - 14.3 [Rate Limiting](#rate-limiting)
