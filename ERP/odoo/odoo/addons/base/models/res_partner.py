...
class Partner(models.Model):
    ...
    partner_latitude = fields.Float(string='Geo Latitude', digits=(8, 12))
    partner_longitude = fields.Float(string='Geo Longitude', digits=(8, 12))
    email = fields.Char()
    ...
    #lat = fields.Float(string='Lat', digits=(8, 12))
    #lng = fields.Float(string='Lng', digits=(8, 12))
    map_view = fields.Char(string='')
    lat = fields.Float(digits=(8, 12))
    lng = fields.Float(digits=(8, 12))
