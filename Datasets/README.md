...
The Pearson correlation heatmap maps pairwise linear relationships between the top-20 features and the target `COL_134`, providing two critical types of insight simultaneously.
...
**Why residual analysis is critical in industrial regression workflows:**
